<Card size="md">
  <Col gap={2}>
    <Row>
      <Caption key="progress_text" value={`Question ${current_question_index + 1} of ${total}`} />
      <Spacer />
      <Caption key="percent_text" value={`${((current_question_index + 1) / total) * 100}%`} color="tertiary" />
    </Row>
