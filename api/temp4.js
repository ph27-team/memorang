(() => {
  ...
  var Pe = (r, t) => ((t = Symbol[r]) ? t : Symbol.for("Symbol." + r)),
    F = (r) => {
      throw TypeError(r);
    };
  var Ke = (r, t, e) =>
    t in r
      ...
      : (r[t] = e);
  var Ie = (r, t) => oe(r, "name", { value: t, configurable: !0 });
  var Le = (r) =>
    [, , , mt(r?.[Pe("metadata")] ?? null)],
    Fe = [
      "class",
      "method",
      "getter",
      ...
      for (var Y = n.length - 1; Y >= 0; Y--)
        ((l = gt(d, e, (p = {}), r[3], $)),
          d &&
            ((l.static = W),
            (l.private = f),
            (R = l.access = { has: f ? (v) => ft(s, v) : (v) => e in v }),
            d ^ 3 &&
              (R.get = f
                ? (v) => (d ^ 1 ? o : k)(v, s, d ^ 4 ? a : w.get)
                : (v) => v[e]),
            d > 2 &&
              (R.set = f
                ? (v, L) => A(v, s, L, d ^ 4 ? a : w.set)
                : (v, L) => (v[e] = L))),
          (c = (0, n[Y])(
            d
              ? d < 4
          ...
          d ^ 4 || c === void 0
            ? j(c) &&
              (d > 4 ? B.unshift(c) : d ? (f ? (a = c) : (w[D] = c)) : (s = c))
            : typeof c != "object" || c === null
              ? F("Object expected")
              : (j((i = c.get)) && (w.get = i),
                j((i = c.set)) && (w.set = i),
                j((i = c.init)) && B.unshift(i)));
      return (d || ae(r, s), w && oe(s, e, w), f ? (d ^ 4 ? a : w) : s);
    },
    ie = (r, t) => Ke(r, typeof t != "symbol" ? t + "" : t, e),
    ce = (r, t) => t.has(r) || F("Cannot " + e),
    ft = (r, t) =>
      Object(t) !== t
    ...
    k = (r, t, e) => (ce(r, t, "access private method"), e);
  var yt = (r) =>
  ...
  var We = {
    ...
    FileAttachmentError: we,
    UnhandledError: ve,
    UnhandledPromiseRejectionError: Ee,
    IntlError: be,
    DomainVerificationRequestError: Te,
    NetworkError: ke,
    FatalAppError: Ce,
  };
  ...
  function Ye(r) {
    let t,
      ...
      s = !1;
    return function (i) {
      if (((t === void 0 && ((t = i), (e = 0), (n = -1))), t === i))
        for (let c = t.length, p = 0; e < c; ) {
          if (
            (s && (t[e] === 10 && (p = ++e), (s = !1)),
            (l = -1),
            e < c && l === -1)
          ...
          if (l === -1) break;
          r(t.subarray(p, l), n), (p = e = l + 1), (n = -1);
        }
      p === c ? (t = void 0) : p !== 0 && (t = t.subarray(p));
    };
  }
  function je(r, t, e) {
    let n = Be(),
    ...
    return function (i, c) {
      if (i.length === 0) (e?.(n), (n = Be()));
        ...
        let p = s.decode(i.subarray(0, c)),
          l = c + (i[c + 1] === 32 ? 2 : 1),
          R = s.decode(i.subarray(l));
        switch (p) {
          case "data":
            n.data = n.data
              ? n.data +
...
` +
  ...
  function xe(r, t) {
    ...
    return new Promise((d, W) => {
      ...
      let P;
      function D() {
        (P.abort(), document.hidden || L());
      }
      p || document.addEventListener("visibilitychange", D);
      let B = Et,
        $ = 0;
      function w() {
      ...
      async function L() {
        ...
        try {
          ...
          if (!P.signal.aborted)
            try {
              let K = (se = c?.(J)) !== null && se !== void 0 ? se : B;
              (window.clearTimeout($), ($ = window.setTimeout(L, K)));
            } catch (K) {
              (w(), W(K));
            }
        }
    ...
    fetch(t, e) {
      return new Promise((n, s) => {
        ...
        if (e.body instanceof FormData) {
          i = {};
          for (let [c, p] of e.body.entries()) i[c] = p;
          e.body = void 0;
        }
        (e.signal &&
    ...
    fetchEventSource(t, e) {
      return new Promise((n, s) => {
        ...
        (this.handlers.set(p, {
          ...
          this.fetchEventSourceHandlers.set(p, { onmessage: a }),
          i &&
  ...
  var q = [
    ...
    Xe = {
      chatkit: { allow: [...q, "thread.item.image_generation"], deny: Re },
      "chatgpt-shell": {
        allow: [
          ...q,
          "command.shareThread",
  ...
  var Ze,
    ...
    Oe,
    T,
    E = class extends ((dt = HTMLElement),
    (ct = [O]),
    (it = [O]),
    (at = [O]),
    (ot = [O]),
    ...
    dt) {
      constructor({ profile: e }) {
        ...
        _(this, x);
        _(this, M);
        _(this, I, this.attachShadow({ mode: "open" }));
        _(this, z);
        _(
          this,
          C,
        ...
        _(
          ...
          new ne({
            fetch: (...e) => {
              let n =
                o(this, h)?.api &&
                "fetch" in o(this, h).api &&
                o(this, h).api.fetch;
              return n ? n(...e) : fetch(...e);
            },
            target: () => o(this, x)?.contentWindow ?? null,
            targetOrigin: new URL(Ge, window.location.origin).origin,
            handlers: {
              ...
              onWidgetAction: async ({ action: e, widgetItem: n }) => {
                let s = o(this, h)?.widgets?.onAction;
                return (
                  s ||
                    k(this, y, V).call(
                      this,
              ...
              onEntitySearch: async ({ query: e }) =>
                o(this, h)?.entities?.onTagSearch?.(e) ?? [],
              onEntityClick: async ({ entity: e }) =>
                o(this, h)?.entities?.onClick?.(e),
              onEntityPreview: async ({ entity: e }) =>
                o(this, h)?.entities?.onRequestPreview?.(e) ?? {
                  preview: null,
                },
              onGetClientSecret: async (e) => (
                (!o(this, h) ||
                  !("getClientSecret" in o(this, h).api) ||
                  !o(this, h).api.getClientSecret) &&
                  k(this, y, V).call(
                    this,
                    new b(
                ...
                o(this, h).api.getClientSecret(e ?? null)
              ),
              onAddMetadataToRequest: ({ op: e, params: n }) => {
                if (
                  !o(this, h) ||
                  !("addMetadataToRequest" in o(this, h).api) ||
                  !o(this, h).api.addMetadataToRequest
                )
                  return null;
                let s = o(this, h).api.addMetadataToRequest({
                  op: e,
                  params: n,
                });
                return s
        ...
        _(this, X, () => {
          ...
          ((this.dataset.loaded = "true"),
            ...
            (e = o(this, z)) == null || e.call(this));
        });
        _(this, U, !1);
        ((this.profile = e), (this.capabilities = Se(e)));
      }
      setProfile(e) {
        ((this.profile = e), (this.capabilities = Se(e)));
      }
    ...
    `;
        ...
        ((n.className = "ck-iframe"),
          ...
          A(this, x, n),
          k(this, y, Ae).call(this, o(this, h)));
        ...
        ((s.className = "ck-wrapper"),
          ...
          o(this, m).on("left_header_icon_click", () => {
            o(this, h)?.header?.leftAction?.onClick();
          }),
          o(this, m).on("right_header_icon_click", () => {
            o(this, h)?.header?.rightAction?.onClick();
          }),
          ...
          k(this, y, Oe).call(this));
      }
      disconnectedCallback() {
        (o(this, x)?.removeEventListener("load", o(this, X)),
          o(this, m).disconnect());
      }
      applySanitizedOptions(e) {
        (A(this, h, e),
          k(this, y, Ae).call(this, e),
          o(this, U)
            ? (k(this, y, _e).call(this, o(this, h)),
              o(this, C).then(() => {
                o(this, m).commands.setOptions(Qe(e));
              }))
            : k(this, y, Oe).call(this));
      }
      setOptions(e) {
      ...
      async fetchUpdates() {
        (await o(this, C), await o(this, m)?.commands.fetchUpdates());
      }
      async sendUserMessage(e) {
        (await o(this, C), await o(this, m)?.commands.sendUserMessage(e));
      }
      async setComposerValue(e) {
        (await o(this, C), await o(this, m)?.commands.setComposerValue(e));
      }
      async setThreadId(e) {
        (await o(this, C),
      ...
      async shareThread() {
        return (await o(this, C), o(this, m)?.commands.shareThread());
      }
      ...
      async showHistory() {
        return (await o(this, C), o(this, m)?.commands.showHistory());
      }
      async hideHistory() {
        return (await o(this, C), o(this, m)?.commands.hideHistory());
      }
  ...
  ((T = Le(dt)),
    ...
    (Ae = function (e) {
      o(this, x) && (o(this, x).title = e?.frameTitle ?? "Chat");
    }),
    (X = new WeakMap()),
    (U = new WeakMap()),
    (Oe = function () {
      if (o(this, U) || !o(this, x) || !o(this, h)) return;
      (A(this, U, !0), k(this, y, _e).call(this, o(this, h)));
      let e = new URL(Ge, window.location.origin);
      (o(this, h).externalVendors?.logRocket &&
        e.searchParams.set("externalVendors", "logrocket"),
        (e.hash = He({
          options: Qe(o(this, h)),
        ...
        o(this, m).connect(),
        (o(this, x).src = e.toString()),
        o(this, M) && o(this, I).append(o(this, M)));
    }),
    S(T, 1, "focusComposer", ct, E),
    S(T, 1, "fetchUpdates", it, E),
    S(T, 1, "sendUserMessage", at, E),
    S(T, 1, "setComposerValue", ot, E),
    S(T, 1, "setThreadId", st, E),
    S(T, 1, "shareThread", rt, E),
    S(T, 1, "sendCustomAction", nt, E),
    S(T, 1, "showHistory", tt, E),
    S(T, 1, "hideHistory", et, E),
    S(T, 1, "setTrainingOptOut", Ze, E),
    ae(T, E));
  ...
  function pt(r = "openai-chatkit") {
    "customElements" in globalThis &&
      (customElements.get(r) || customElements.define(r, Me));
  }
  pt();
})();